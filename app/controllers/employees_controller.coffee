...
class EmployeesOverview extends Spine.Controller
	...
	mockEmployees: ->
		Employee.create { firstName: 'Терминал 1', lastName: '1', port: '8080', startDate: '01/07/2006' }
		Employee.create { firstName: 'Терминал 2', lastName: '2', port: '8080', startDate: '02/17/2006' }
		Employee.create { firstName: 'Терминал 3', lastName: '3', port: '8080', startDate: '03/01/2006' }
		Employee.create { firstName: 'Терминал 4', lastName: '4', port: '8080', startDate: '04/01/2006' }
